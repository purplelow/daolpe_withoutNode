...
export default class DrawerrMultilevel extends Drawerr {
  constructor(args) {
    ...
    this.options.navigationText = args.navigationText || navigationText;
    this.options.toggleBtnAriaLabel =
      args.toggleBtnAriaLabel || toggleBtnAriaLabel;
    this.options.closeMenuBtnLabel =
      args.closeMenuBtnLabel || closeMenuBtnLabel;
    ...
    this.multilevelSettings.submenus =
      this.drawerr.querySelectorAll("ul li ul");
    ...
    this.toggleBtn.setAttribute("aria-label", this.options.toggleBtnAriaLabel);
  ...
  insertNavigation() {
    ...
    this.navigationContainer.insertAdjacentHTML(
      "afterbegin",
      ` <a tabIndex="-1" class="${this.multilevelSettings.navigationTextClass}" href="#"><span class="${this.multilevelSettings.navigationTextClass}__icon ${this.multilevelSettings.hiddenClass}"></span><span class="${this.multilevelSettings.navigationTextClass}__text">${this.options.navigationText}</span></a>`
    );
  }
  ...
  navigationOnClick() {
    this.navigation.addEventListener("click", (e) => {
      ...
      this.multilevelSettings.activeSubmenu =
        this.multilevelSettings.activeSubmenu.parentElement.parentElement;
